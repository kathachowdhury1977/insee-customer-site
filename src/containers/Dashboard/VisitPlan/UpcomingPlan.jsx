         ...
         <span className="planned"><img src={plan}/> 10:00AM &nbsp; &nbsp; Planned</span>
          <div className="row">
            <div className="section-item">
              ...
              <div className="col-sm-6 col-md-6 sec_details">
          ...
          <div className="progress-sec">
            <ul className="container">
              ...
              <li className="col-sm-4 col-lg-4 col-md-4">
                ...
                <span className="percentage">{props.inseeGrowth}</span>
              </li>
              <li className="col-sm-4 col-lg-4 col-md-4">
          ...
          {t("lastcaptured.label")} <span>20-11-2020</span> {t("by.label")} <span>Jhon Smith</span>
          </div>
        </div>
        </Link>
      </div>
