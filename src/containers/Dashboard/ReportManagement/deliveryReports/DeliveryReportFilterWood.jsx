...
const DeliveryReportFilterWood = ({ setFilterState, filterState, filterReports, clearAll, resetCount, setDateError, dateError, INITIAL_FILTER_STATE }) => {
    ...
    const { companyList, contractDeopdownList, deliveryMaterialDropdownList, shipToNameDropdownList, ticketNoList, deliveryshippingConditionCWDropdownList } = deliveryReports;
    const COMPANY_LIST = companyList;

    const SHIPPING_CONDITION = deliveryshippingConditionCWDropdownList;
    ...
    return (
        <Grid container spacing={2} mt={2} columns={10}>
            ...
            <Grid item md={2} sm={4} xs={12} className="reportInputText">
                <TextField
                    id="standard-basic"
                    label={t("report.preDoNo")}
                    variant="standard"
                    style={{ width: "100%" }}
                    name="preDoNo"
                    value={filterState.preDoNo}
                    onChange={handleFilterChange}
                />
            ...
            <Grid item md={2} sm={4} xs={12}></Grid>
            <Grid item md={2} sm={4} xs={12}>
                <ReportDatePicker
...
export default DeliveryReportFilterWood