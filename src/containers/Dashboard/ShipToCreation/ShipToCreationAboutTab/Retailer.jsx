            ...
            <div className="product_brand_section reailer-box">
                <div className="row">
                    <div className="col-12">
                        <div className="product_heading">Retailer</div>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="product_bottom_item">
                            <p><span className="lightText">Last added on</span> <span className="darkText">20-11-2020</span> | <span className="lightText">by</span> <span className="darkText">John Smith</span> &nbsp; <a href="#">View All Retailers</a></p>
                        </div>
                    </div>
                </div>
