...
export default function FailureStatus(props) {
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row">
                                    ...
                                    <div className="col-sm-12 text-center">
                                        <p className="mb-0">
                                            <i style={{fontSize: '45px'}} class="fa fa-exclamation-circle text-failure" aria-hidden="true"></i>
                                        </p>
                                        <p style={{ fontSize: '25px' }}>Failure!</p>
                                        <p  className="mb-0" style={{ fontSize: '18px', color: 'red' }}>{props.message}</p>
                                    </div>
