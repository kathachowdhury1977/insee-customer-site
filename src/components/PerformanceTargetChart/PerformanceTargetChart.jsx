...
import "./PerformanceTargetChart.scss";
import {
  Chart,
  ArgumentAxis,
  ValueAxis,
...
import { performanceTarget as data } from "./TargetData";
...
export default class PerformanceTargetChart extends React.PureComponent {
  constructor(props) {
    super(props);
